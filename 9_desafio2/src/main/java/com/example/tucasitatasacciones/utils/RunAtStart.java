...
import com.example.tucasitatasacciones.TuCasitaTasaccionesApplication;
...
public class RunAtStart implements ApplicationRunner {
    final static Logger logger = LoggerFactory.getLogger(TuCasitaTasaccionesApplication.class);
    ...
    public void run(ApplicationArguments args) {
        if (refresh) {
            logger.error("Aun sin hacer nada");
            refresh();
        }
    }

    public static void refresh() {
        copyToFile("./dDistricts.json", "./districts.json");
    }
