...
public class EnvironmentDTO {
    ...
    @Size(min = 1, message = "El nombre del ambiente no puede estar vacío.")
    ...
    @DecimalMin(value= "0.1", message = "El mínimo ancho permitido por ambiente es de 0.1 mts.")
    private double environment_width;

    @NotNull(message = "El ancho del ambiente no puede estar vacío.")
    @DecimalMax(value= "33.0", message = "El máximo largo permitido por ambiente es de 33 mts.")
    @DecimalMin(value= "0.1", message = "El mínimo largo permitido por ambiente es de 0.1 mts.")
