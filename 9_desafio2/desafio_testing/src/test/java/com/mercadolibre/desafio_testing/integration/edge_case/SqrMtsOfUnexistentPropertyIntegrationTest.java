...
@DirtiesContext
public class SqrMtsOfUnexistentPropertyIntegrationTest {
    @Autowired
    ...
    @Test
    public void gettingSqrMtsOfUnexistentPropertyGivesCorrectMessage()
            throws Exception {
        ...
        this.mockMVC.perform(MockMvcRequestBuilders.get(
                ConstantsUtils.PROPERTY_ENDPOINT + "/abc" +
