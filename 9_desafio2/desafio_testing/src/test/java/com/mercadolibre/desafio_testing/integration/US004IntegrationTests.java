...
@DirtiesContext
public class US004IntegrationTests {
    @Autowired
    ...
    @Test
    public void getRoomsOfPropertyRespondsCorrectly() throws Exception {
    ...
    @Test
    public void getRoomsOfPropertyRespondsCorrectly2() throws Exception {
        String districtJson = FileUtils.objectMapper.writeValueAsString(
                this.district2);
        String propertyJson = FileUtils.objectMapper.writeValueAsString(
                this.property2);
