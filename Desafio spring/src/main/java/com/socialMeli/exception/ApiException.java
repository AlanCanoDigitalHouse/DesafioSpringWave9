...
public class ApiException {
    ...
    public ResponseEntity<ErrorMessage> emptyModelList(EmptyModelList ex) {
        return new ResponseEntity<>(new ErrorMessage("Model not found", ex.getMessage()), HttpStatus.NOT_FOUND);
    }


    @ExceptionHandler(ModelAlreadyExists.class)
    public ResponseEntity<ErrorMessage> emptyModelList(ModelAlreadyExists ex) {
        return new ResponseEntity<>(new ErrorMessage("Model already exists", ex.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorMessage> followHimself(FollowHimselfException ex) {
        return new ResponseEntity<>(new ErrorMessage("User cant follow himself", ex.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorMessage> alreadyFollowed(AlreadyFollowedException ex) {
        return new ResponseEntity<>(new ErrorMessage("User already following this user", ex.getMessage()), HttpStatus.NOT_FOUND);
    }

    //Default exceptions
    @ExceptionHandler(NumberFormatException.class)
    public ResponseEntity<ErrorMessage> numberFormatException(NumberFormatException ex) {
        return new ResponseEntity<>(new ErrorMessage("Bad entry", ex.getMessage()), HttpStatus.NOT_FOUND);
    }
