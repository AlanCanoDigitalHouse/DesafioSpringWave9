...
public class ProductsController {
    ...
    public ResponseEntity<String> newPost(@RequestBody @Valid PostDTO postDTO) throws SellerNotFoundException {
    ...
    public ResponseEntity<String> newPostPromo(@RequestBody @Valid PostPromoDTO promoPostDTO) throws SellerNotFoundException {
    ...
    public ResponseEntity<FollowedPostsDTO> twoWeeksPostList(@PathVariable Integer userId,
    ...
    public ResponseEntity<SellerPostsPromoDTO> promoCount(@PathVariable Integer userId) throws SellerNotFoundException {
