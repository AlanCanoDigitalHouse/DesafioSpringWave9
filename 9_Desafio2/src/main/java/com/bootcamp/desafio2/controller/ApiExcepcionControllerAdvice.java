...
public class ApiExcepcionControllerAdvice {
    ...
    @ResponseBody
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorMessageDto handler(DistrictNotFoundException e){
        HashMap<String, String> fields = new HashMap<String, String>();
        fields.put("district",e.getMessage());
        return new ErrorMessageDto(HttpStatus.BAD_REQUEST.value(),"District error", fields);
    }
