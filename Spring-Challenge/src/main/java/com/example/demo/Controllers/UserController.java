...
public class UserController {
    ...
    public ResponseEntity<FollowersDTO> getFollowersAmount(@PathVariable int userId) throws ExceptionHandler {
        return new ResponseEntity(userService.getFollowersAmount(userId), HttpStatus.OK);
    }

    @GetMapping("/{userId}/followers/list")
    public ResponseEntity<FollowListDTO> getListFollowers(@PathVariable int userId, @RequestParam(defaultValue = "name_asc") String order) throws ExceptionHandler {
        return new ResponseEntity(userService.getListFollowers(userId, order), HttpStatus.OK);
    }

    @GetMapping("/{userId}/followed/list")
    public ResponseEntity<FollowListDTO> getListFollowed(@PathVariable int userId, @RequestParam(defaultValue = "name_asc") String order) throws ExceptionHandler {
    ...
    public ResponseEntity<String> addFollower(@PathVariable int userId, @PathVariable int userIdToFollow) throws ExceptionHandler {
    ...
    public ResponseEntity<String> removeFollower(@PathVariable int userId, @PathVariable int userIdToUnfollow) throws ExceptionHandler {
